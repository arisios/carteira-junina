      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-sm animate-slide-up">
          <div className="text-center mb-8">
            ...
            <h1 className="font-display text-3xl font-bold" style={{color:'#4B1E6D'}}>Carteira Junina</h1>
            <p className="text-sm mt-1 font-semibold tracking-wide uppercase" style={{color:'#C79A3B'}}>Juninas do Rio · 2026</p>
          </div>
          <div className="card-junina p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input name="identifier" className="input-junina"
          ...
          <p className="text-center text-xs mt-5" style={{color:'rgba(199,154,59,0.6)'}}>Juninas do Rio 2026 · Carteira Digital</p>
        </div>
      </div>
